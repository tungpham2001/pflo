        ...
        >
            <defs>
                <pattern id="backgroundImage" patternUnits="userSpaceOnUse" width="400" height="300">
                    <image href={backgroundImage} x="0" y="-140" width="440" height="680" />
                </pattern>
            </defs>
            ...
            <path d="M396.63 267H1V114.725L99.0621 38.587H396.63V267Z" fill="url(#backgroundImage)" fill-opacity="0.7" stroke="black" stroke-width="2"/>
            <path d="M1 114.725L16.9 77.1377" stroke="black" stroke-width="2"/>
            <text x="380" y="80" fill="white" text-anchor="end">{text}</text>
            {techStacks.map((tech, index) => (
                <text key={index} x="20" y={140 + index * 20} fill="white">{tech}</text>
            ))}
        </svg>
    );
};
